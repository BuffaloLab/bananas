	      ***************************************
           ...
           PBS Materials Variety Pack (Integrity Software and Games)

	      ***************************************

Thank you for downloading this materials package. I have personally made all materials and their associated textures: no textures have been downloaded from external sources.
...
Most textures are 2048x2048 or 1024x1024 so be sure to adjust max size in the texture import settings to your desired size. Because many materials use multiple textures it is often best to adjust the resolution of the main (albedo) texture and then use the same res. on normal, heightmap, occlusion, etc..
...
If you have any questions about this asset, or you have a particular material that you would like for me to include, please email me at:
